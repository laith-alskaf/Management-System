...
from syrian_procurement_system.services.local_db_service import LocalDbService
from syrian_procurement_system.views.main_views.suppliers_view import SuppliersView, SupplierDialog
from syrian_procurement_system.models.supplier_model import Supplier
